      ...
      {appView === 'dashboard' && (
        <div style={{minHeight:'100vh',background:'var(--bg)',fontFamily:'var(--font-sans)',display:'flex',flexDirection:'column',alignItems:'center'}}>
          ...
          <div style={{width:'100%',maxWidth:720,padding:'0 24px 48px',boxSizing:'border-box'}}>
            ...
            {/*
              The NSGP deadline summary lives on the Next.js toolbox page, not here.
              This dashboard is only reached inside the /loe iframe, which the
              toolbox always enters with a ?view — so a card added here was never
              on anyone's path. One rendering of those dates, in the place reps
              actually land.

              The editor itself stays in the Pre-Call view below: this app owns the
              table, and the toolbox reads it through the proxy and links back here
              to change it.
            */}
          </div>
        </div>
