...
const DEFAULT_PROPOSAL = {
  ...
  phases: [
    ...
    { title:"3. AWARD IMPLEMENTATION PERIOD — STRATEGIC CONSULTATIVE SUPPORT",
      body:"Following State authorization, NPSA remains available to provide consultative guidance regarding implementation planning, procurement considerations, reimbursement readiness, documentation, and grant administration best practices. Comprehensive implementation services may be provided under a separate written agreement.",
      deliverable:"Successful implementation of approved security improvements." },
  ],
