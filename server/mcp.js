  ...
  if (canWrite) {
    ...
    server.registerTool('client_update', {
      ...
      inputSchema: {
        ...
        mark_documents_received: z.array(z.string()).optional().describe('Document keys (from client_get documents) that arrived outside the form, e.g. by email. They then count as received on the dialog, the client\'s Documents tab and the submission box.'),
        unmark_documents_received: z.array(z.string()).optional().describe('Take back a received mark'),
