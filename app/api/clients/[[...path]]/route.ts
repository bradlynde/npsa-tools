...
const PATCHABLE = new Set(["applications", "invite_contact_email", "mark_documents_received", "unmark_documents_received", "documents", "add_documents", "remove_document_keys", "add_reference_contacts", "remove_contact_emails"]);
